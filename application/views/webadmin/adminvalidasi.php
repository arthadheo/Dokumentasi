					...
					<?php if (isset($doksidangtype1)) { ?>
                        <tbody>
                            <tr>
								...
								<?php }else { ?>
                                    <td class="text-center">
										<span class="label label-success">File belum ditandatangani</span>
									</td>
								<?php } ?>
                                <td>
                                </td>
					...
					<?php if (isset($dokyudisiumtype1)) { ?>
                        <tbody>
                            <tr>
								...
								<?php }else { ?>
                                    <td class="text-center">
                                        <a href="<?php echo base_url(); ?>document/sidang/<?php echo $dokyudisiumtype1->dokumen; ?>" download>Berita Acara Seminar Kemajuan</a>
                                    </td>
								<?php } ?>
                                <td class="text-center">
					...
					<?php if (isset($dokyudisiumtype2)) { ?>
                        <tbody>
                            <tr>
								...
								<?php }else { ?>
                                    <td class="text-center">
                                        <a href="<?php echo base_url(); ?>document/sidang/<?php echo $dokyudisiumtype2->dokumen; ?>" download>Revisi Laporan Tugas Akhir</a>
                                    </td>
								<?php } ?>
                                <td class="text-center">
					...
					<?php if (isset($dokyudisiumtype3)) { ?>
                        <tbody>
                            <tr>
								...
								<?php }else { ?>
                                    <td class="text-center">
                                        <a href="<?php echo base_url(); ?>document/sidang/<?php echo $dokyudisiumtype3->dokumen; ?>" download>Surat Keterangan Perbaikan Tugas Akhir</a>
                                    </td>
								<?php } ?>
                                <td class="text-center">
