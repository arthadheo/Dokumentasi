					...
					<thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php }elseif ($dokyudisiumtype1->status == 6 || $dokyudisiumtype1->status == 2) { ?>
                                    <td class="text-center">    
                                ...
                                <?php 
                                    ...
                                    }elseif ($dokyudisiumtype1->status == 6) {
					...
					<?php if (isset($dokyudisiumtype2)) { ?>
                        <tbody>
                            <tr>
                                ...
                                <?php }elseif ($dokyudisiumtype2->status == 6 || $dokyudisiumtype2->status == 2) { ?>
                                    <td class="text-center">    
                                ...
                                <?php 
                                    if ($dokyudisiumtype2->status == 1) {
                                        ...
                                        $status = "File update terupload";
                                    }elseif ($dokyudisiumtype2->status == 6) {
                                        $status = "File sudah ditandatangani";
                                    }
                                    ?>
                                    <span class="label label-success"><?php echo $status ?></span>
					...
					<?php if (isset($dokyudisiumtype3)) { ?>
                        <tbody>
                            <tr>
                                ...
                                <?php }elseif ($dokyudisiumtype3->status == 6 || $dokyudisiumtype3->status == 2) { ?>
                                    <td class="text-center">    
