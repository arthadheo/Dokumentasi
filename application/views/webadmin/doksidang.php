					...
					<thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <?php }elseif ($doksidangtype1->status == 6 || $doksidangtype1->status == 2) { ?>
                                    <td class="text-center">    
					...
					<?php if (isset($doksidangtype2)) { ?>
                        <tbody>
                            <tr>
                                ...
                                <?php }elseif ($doksidangtype2->status == 6 || $doksidangtype2->status == 2) { ?>
                                    <td class="text-center">    
					...
					<?php if (isset($doksidangtype3)) { ?>
                        <tbody>
                            <tr>
                                ...
                                <?php }elseif ($doksidangtype3->status == 6 || $doksidangtype3->status == 2) { ?>
                                    <td class="text-center">    
					...
					<?php if (isset($doksidangtype5)) { ?>
                        <tbody>
                            <tr>
                                ...
                                <?php }elseif ($doksidangtype5->status == 6 || $doksidangtype5->status == 2) { ?>
                                    <td class="text-center">    
